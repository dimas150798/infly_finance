...
<div class="content-wrapper">
    ...
    <div class="container-xxl">
                ...
                <div class="col-7 d-flex justify-content-end">
                    <div class="dropdown-fitur text-end">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
                            <li><a class="dropdown-item" href="<?= url('pendapatan/formaddpendapatan') ?>"><i
                                        class="bi bi-plus-circle-fill text-warning"></i> Add Pendapatan</a></li>

                            <li><a class="dropdown-item export-excel" href="<?= url('pendapatan/exporttoexcel') ?>"><i
                                        class="bi bi-file-earmark-spreadsheet-fill text-warning "></i> Export Excel</a>
                            </li>
                            <li><a class="dropdown-item posting" href="<?= url('pendapatan/postingpendapatan') ?>"><i
        ...
        <div class="card p-3">
            <table class="table table-bordered data-pendapatan" id="data-pendapatan">
                <thead>
                    <tr>
